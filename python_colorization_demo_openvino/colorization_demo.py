...
if __name__ == '__main__':
    ...
    video_writer_ful = cv.VideoWriter()
    if args.output and not video_writer_ful.open("2337_o_n.avi", cv.VideoWriter_fourcc(*'MJPG'),
                                             cap.fps(), (2610,2001)): raise RuntimeError("Can't open video writer")
    ...
    while original_frame is not None:
        ...
        video_writer_ful.write((img_bgr_out*255).astype(np.uint8))
