...
class EngineBuilder:
    ...
    def __init__(self, verbose=False):
        ...
        #profile.set_shape("input.1", (3, 127, 127), (3, 277, 277), (3, 377, 377)) 
    ...
    def create_network(self, onnx_path):
        ...
        info = [i for i in self.network]
        log.info("Network ALL")
        for layer in info:
            log.info("Input '{}' with shape {} and type {}".format(layer.name, layer.num_inputs, layer.type))
    ...
    def create_engine(self, engine_path, precision, calib_input=None, calib_cache=None, calib_num_images=25000,
        ...
        inputs = [self.network.get_input(i) for i in range(self.network.num_inputs)]
        #self.config.set_flag(trt.BuilderFlag.REFIT)
        if precision == "fp16":
